...
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=latin1 COLLATE=latin1_bin;insert into `medecin` (`Civilite`, `Nom`, `Prenom`, `idMedecin`) values ('1', 'dardet', 'lenny', 1);
...
) ENGINE=InnoDB AUTO_INCREMENT=17 DEFAULT CHARSET=latin1 COLLATE=latin1_bin;insert into `patient` (`Adresse`, `Civilite`, `Code_postal`, `Date_de_naissance`, `Lieu_de_naissance`, `Nom`, `Numero_Securite_Sociale`, `Prenom`, `Ville`, `idMedecin`, `idPatient`) values ('118 route de Narbonne', '1', '2000-01-01', 'Toulouse', 'Toulouse', 'Dardet', 'jenfjen', 'Lenny', '31400', '1', 16);
...
) ENGINE=InnoDB AUTO_INCREMENT=23 DEFAULT CHARSET=utf8mb4;insert into `consultation` (`DateConsultation`, `Duree`, `Heure`, `idConsultation`, `idMedecin`, `idPatient`) values ('2024-03-08', 60, '01:01:11', 1, 1, 16);
insert into `consultation` (`DateConsultation`, `Duree`, `Heure`, `idConsultation`, `idMedecin`, `idPatient`) values ('2000-01-01', 15, '10:00:00', 22, 1, 16);
